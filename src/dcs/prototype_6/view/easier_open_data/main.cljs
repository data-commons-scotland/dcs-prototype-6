...
(defn dataset-row
      ...
      [:tr {:id dataset-ele-id}
       [:td dataset]
       [:td description]
       [:td [:a {:href (str util/easier-repo-data csv)} "CSV"] "  " (if (nil? json)
                                                                      ""
                                                                      [:a {:href (str util/easier-repo-data json)} "JSON"])]
       [:td number]
       [:td creator]
       [:td supplier [:sup [:a {:href supplier-url} (gstring/unescapeEntities "&nbsp;") "URL"]]]
       [:td [:a {:href licence-url} licence]]])
      ...
      [:div
       ...
       [:section.hero {:style {:backgroundColor "#fff1e5"}}
        [:div.hero-body
         [:div.container
          [:div.content
           [:h2.subtitle.is-4.has-text-danger [:span "The 11 " [:em "easier"] " datasets"]]
           [:table#easier-table-fff1e5.table.is-hoverable.is-narrow
            [:thead
             ...
             [:tr.has-text-left
              ...
              [:th.has-text-danger [:span.icon-text
                                    [:span "file"]
          ...
          [:div.content
           ...
           [:table#easier-table-f2dfce.table.is-hoverable.is-narrow
            ...
            [:tbody
             ...
             (dimension-row "1" "business-sector" "1" "The label representing the business/economic sector." "business-waste-by-sector" "business-waste-by-sector" "Manufacture of food and beverage products" "10" "" "")
             ...
             (dimension-row "business-waste-by-region" "business-waste-by-region" "2011" "8" "2011" "2018")

             (dimension-row "business-waste-by-sector" "business-waste-by-sector" "2011" "8" "2011" "2018")

             (dimension-row "waste-site" "waste-site" "2019" "1" "2019" "2019")

             (dimension-row "waste-site-io" "waste-site-io" "2013" "14" "2007" "2020")

             (dimension-row "stirling-bin-collection" "stirling-bin-collection" "2018" "4" "2018" "2021")
             ...
             (dimension-row "stirling-bin-collection" "stirling-bin-collection" "3" "4" "" "")
             ...
             (dimension-row "stirling-bin-collection" "stirling-bin-collection" "Vegetal wastes" "6" "" "")
             ...
             (dimension-row "1" "missed-bin?" "1" "True if the waste was in a missed bin." "stirling-bin-collection" "stirling-bin-collection" "false" "2" "" "")
             ...
             (dimension-row "business-waste-by-region" "business-waste-by-region" "753" "" "0" "486432")

             (dimension-row "business-waste-by-sector" "business-waste-by-sector" "54" "" "0" "1039179")

             (dimension-row "waste-site-io" "waste-site-io" "0" "" "-8.56" "2325652.83")

             (dimension-row "stirling-bin-collection" "stirling-bin-collection" "1.24" "" "0.3" "5447.70")
