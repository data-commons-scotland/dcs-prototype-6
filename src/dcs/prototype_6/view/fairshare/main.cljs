...
(defn root []
  ...
  [:div
   ...
   [:section.hero.is-small.has-background {:style {:backgroundColor "#0f5499"}}
    ...
    [:div.hero-body
     [:div.container
      ...
      [:div.content.is-small.has-text-info
       [:ol.is-lower-alpha
        [:li [:a {:href   "https://www.stirlingstudentsunion.com/sustainability/fairshare/"
                  :target "_blank"} "The Fair Share"]
         " is run by the Student Union at the University of Stirling. It meets the "
         [:a {:href   "https://www.zerowastescotland.org.uk/revolve"
              :target "_blank"} "Revolve"] " quality standard for second-hand stores."]]]]]]
