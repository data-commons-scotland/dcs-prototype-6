...
(defn ele [region]
  ...
  (let [points-of-interest 
        {"Aberdeen City"     [:div.content.has-text-centered
         ...
         "Aberdeenshire"     [:div.content.has-text-centered
                              "Aberdeenshire's household waste is now approaching the Scottish average."] 
         "City of Edinburgh" [:div.content.has-text-centered
         ...
         "Clackmannanshire"  [:div.content.has-text-centered
         ...
         "Dundee City"       [:div.content.has-text-centered
         ...
         "Perth and Kinross" [:div.content.has-text-centered
