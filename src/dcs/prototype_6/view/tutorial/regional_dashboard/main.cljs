  ...
  [:div.section
   ...
   [:div.container
    [:div.content
     ...
     "[:h2 "What are the data and where do they come from?"]"
     ...
     "[:h2 "Interpreting the graphs and other data visualisations"]"
     ...
     [:div.columns.is-vcentered
      ...
      [:div.column.is-one-quarter
       [:div.content
        "Insert Stirling Composition graph here"
        ]]
      [:div.column
       [:div.content
     ...
     [:div.columns.is-vcentered
      ...
      [:div.column.is-one-quarter
       [:div.content
        "Insert Stirling Management graph here"
        ]]]
